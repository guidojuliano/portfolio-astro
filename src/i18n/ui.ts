...
export const ui = {
  ...
  es: {
    ...
    "projects.project1": "Quix - Ecommerce",
    "projects.description1":
      "Sitio de Ecomerse construido con NextJS en donde implemente data fetching y data mutation con GraphQL, manejo de cookies, implementación de middleware para control de rutas, implementación de IA para crear un chat-bot, SEO, análisis de performance, entre otras cosas",
    "projects.project2": "Arkanoid",
